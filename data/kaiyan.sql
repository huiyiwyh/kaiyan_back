...
CREATE TABLE `ruser` (
  ...
  `Jbrief` varchar(48) COLLATE utf8_bin DEFAULT '这个人很懒，什么都没留下' COMMENT '个人简介',
  ...
  `Rindexback` varchar(30) COLLATE utf8_bin DEFAULT 'index/default.jpg' COMMENT '主页背景',
