...
select * from vuserlabel;

select * from warticlelabel;


insert into warticlelabel(Uname) values ('旅游');
insert into warticlelabel(Uname) values ('体育');
insert into warticlelabel(Uname) values ('游戏');
insert into warticlelabel(Uname) values ('娱乐');
insert into warticlelabel(Uname) values ('花鸟');
insert into warticlelabel(Uname) values ('剑网三');
insert into warticlelabel(Uname) values ('天下三');
insert into warticlelabel(Uname) values ('过年');
insert into warticlelabel(Uname) values ('篮球');
insert into warticlelabel(Uname) values ('环法');
insert into warticlelabel(Uname) values ('环意');
insert into warticlelabel(Uname) values ('足球');

select * from ysubjectlabel;

delete from vuserlabel where Qlabel = 1;


insert into vuserlabel values('717729520',1,10,0);
insert into vuserlabel values('717729520',2,7,0);
insert into vuserlabel values('717729520',3,5,0);
insert into vuserlabel values('717729520',4,2,0);
insert into vuserlabel values('717729520',5,12,0);
insert into vuserlabel values('717729520',6,3,0);
insert into vuserlabel values('717729520',7,5,0);
insert into vuserlabel values('717729520',8,4,0);
insert into vuserlabel values('717729520',9,11,0);
insert into vuserlabel values('717729520',10,6,0);
insert into vuserlabel values('717729520',11,9,0);
insert into vuserlabel values('717729520',12,1,0);

select Qlabel,Lvalue from vuserlabel where Xaccount = '717729520' and Otype = 0;


select Xaid,Vlabel from larticle;


insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729520','717729520',1,'1_2_3_4');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729521','717729520',0,'3_1_10_9');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729522','717729520',0,'7_2_3_4');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729523','717729520',0,'9_4_10_6');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729524','717729520',2,'3_10_4_7');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729525','717729520',0,'9_1_7_8');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729526','717729520',1,'8_2_1_4');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729527','717729520',1,'10_2_7_9');


insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729528','717729520',1,'1_23_2_4');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729529','717729520',0,'87_2_7_9');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729530','717729520',1,'8_1_18_4');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729531','717729520',0,'10_8_7_9');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729532','717729520',1,'8_28_11_4');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729533','717729520',1,'7_2_12_9');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729534','717729520',0,'17_19_14_15');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729536','717729520',1,'27_23_24_35');
insert into larticle (Xaid,Vaccount,Oread,Vlabel) values('20180509717729535','717729520',1,'123_1_21_25');


select * from warticlelabel;

select * from view_article_history;

select Qlabel,Lvalue from vuserlabel where Xaccount = '717729520' and Otype = 0;


select * from larticle;
select * from ohistory;

set FOREIGN_KEY_CHECKS=1;

insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729520','717729520','2018-04-02 12:32');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729521','717729520','2018-04-02 12:33');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729522','717729520','2018-04-02 12:34');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729523','717729520','2018-04-02 12:35');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729524','717729520','2018-04-02 12:36');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729525','717729520','2018-04-02 12:37');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729526','717729520','2018-04-02 12:38');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729527','717729520','2018-04-02 12:39');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729528','717729520','2018-04-02 12:40');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729529','717729520','2018-04-02 12:41');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729530','717729520','2018-04-02 12:42');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729531','717729520','2018-04-02 12:43');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729532','717729520','2018-04-02 12:44');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729533','717729520','2018-04-02 12:45');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729534','717729520','2018-04-02 12:46');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729535','717729520','2018-04-02 12:47');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729536','717729520','2018-04-02 12:48');
insert into ohistory(Gaid,Aaccount,Pdate) values ('20180509717729537','717729520','2018-04-02 12:49');
...
select * from view_history_search
select * from yhissearch

select * from ruser where Raccount = '879646529'

select * from view_action where account = '879646528'
select * from view_article where sid = '1' and date >  '2018-03-05 18:18'
select id,title,account,nickname,head,date,thumbnail,countComment,countLike,countRead from view_article where sid = '1' and date > '2018-03-05 18:18'



select * from larticle where Xaid = '879646528180323135935'
